...
const tasks=[
  ...
  {externalId:'b',title:'明确时段任务',dueDate:'2026-08-21',startAt:'2026-08-21T09:00:00+08:00',dueAt:'2026-08-21T10:30:00+08:00',allDay:false,done:false,content:'会议'},
...
test('local calendar mirrors only explicit source dates and never invents a timed duration',()=>{
  ...
  assert.doesNotMatch(ics,/DTSTART:20260822T160000Z/);

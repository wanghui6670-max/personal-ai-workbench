...
export const WORKBENCH_ENV_KEYS=Object.freeze([
  ...
  'AI_PROVIDER_NETWORK_ZONE',
  'AI_PROVIDER_MODEL',
  'AI_PROVIDER_API_KEY',
  'AI_PROVIDER_GROK_MODEL',
  'AI_PROVIDER_GROK_API_KEY',
  'AI_PROVIDER_ACTIVE_MODEL',
  'AI_PROVIDER_ALLOW_ANONYMOUS',
  'AI_PROVIDER_WORKFLOWS',
  'AI_PROVIDER_REASONING_MODE',
  'AI_PROVIDER_ALLOW_REASONING_DOWNGRADE',
  'AI_PROVIDER_STRUCTURED_OUTPUT_MODE',
  'AI_PROVIDER_ALLOW_SCHEMA_DOWNGRADE',
  'AI_PROVIDER_NO_STORE_MODE',
  'AI_PROVIDER_ALLOW_NO_STORE_DOWNGRADE',
  'AI_PROVIDER_CHAT_TOKEN_FIELD',
  'AI_PROVIDER_TIMEOUT_MS',
  'AI_PROVIDER_MAX_RESPONSE_BYTES',
  'AI_SEND_FILE_CONTENT',
  'TRUSTED_ORIGINS',
  'ALLOW_INSECURE_PUBLIC',
  'WORKBENCH_RATE_LIMIT_WINDOW_MS',
  'WORKBENCH_RATE_LIMIT_MAX_CLIENTS',
  'WORKBENCH_CAPTURE_RATE_LIMIT',
  'WORKBENCH_SYNC_RATE_LIMIT',
  'WORKBENCH_MORNING_RATE_LIMIT',
  'FEISHU_CLI_PATH',
  'WORKBENCH_SCAN_MAX_FILES',
  'WORKBENCH_SCAN_MAX_DIRECTORIES',
  'WORKBENCH_SCAN_MAX_DEPTH',
  'WORKBENCH_SCAN_MAX_DURATION_MS'
]);
